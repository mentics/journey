...
whenStrat(from::DateTime, isMktOpen::Bool, tsMktChange::DateTime) = nextMarketPeriod(from, isMktOpen, tsMktChange, Second(120) ÷ max(1, length(SchedStrat.UseExps)), Second(0), Minute(4))
