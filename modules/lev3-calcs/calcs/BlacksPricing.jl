...
using SH
priceOption(under, texPY, leg, vty)::Float64 = priceOption(getStyle(leg), getStrike(leg), texPY, vty, under)
...
function priceOption(style::Style.T, strike::Real, toExpYear::Real, vty::Real, under::Real)::Float64
